...
const lenders = [
    { name: 'Demo User', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: '' },
    ...
    { name: 'Demo User', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: '' },
