...
// In Docker/production we proxy API via Nginx at /api.
...
export const fetchPublicInvoice = (publicId) => API.get(`/public/invoices/${publicId}`)
export const payPublicInvoice = (publicId, payload) => API.post(`/public/invoices/${publicId}/pay`, payload)